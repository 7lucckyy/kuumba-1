...
const MissionAndAim: FunctionComponent<MissionAndAimProps> = () => {
  return (
    <section id="about-us" className="flex flex-col gap-8 px-4 rounded-lg py-14 sm:py-20 md:py-24 lg:py-32 lg:flex-row sm:gap-12 md:gap-16 lg:gap-20 xl:gap-24 md:px-12 lg:px-20 xl:px-24 bg-[#F5F6FF]">
      <div className="flex flex-col w-full gap-1 md:gap-3 lg:gap-5 xl:gap-6 basis-[56%]">
      ...
      <div className="flex flex-col w-full gap-1 md:gap-3 lg:gap-5 xl:gap-6 basis-[44%]">
